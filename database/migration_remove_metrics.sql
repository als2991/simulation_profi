...
UPDATE tasks SET description_template = 'Теперь давай следующее задание — конфликт команды и клиента.'
WHERE "order" = 2 AND scenario_id = 1;

UPDATE tasks SET description_template = 'Теперь дай следующее задание — нужно принять решение по релизу с учётом риска 40%, ограничений сроков и требований.'
