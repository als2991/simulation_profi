...
(1, 'Теперь давай следующее задание — конфликт команды и клиента.', 2, 'conflict', 15),
(1, 'Теперь дай следующее задание — нужно принять решение по релизу с учётом риска 40%, ограничений сроков и требований.', 3, 'deadline', 15)
ON CONFLICT DO NOTHING;
